...
public enum CursedTechnique {
    ...
    LIMITLESS(JJKAbilities.UNLIMITED_VOID.get(), JJKAbilities.INFINITY.get(), JJKAbilities.RED.get(), JJKAbilities.BLUE.get(),
            JJKAbilities.MAXIMUM_BLUE_MOTION.get(), JJKAbilities.MAXIMUM_BLUE_STILL.get(), JJKAbilities.BLUE_FISTS.get(), JJKAbilities.HOLLOW_PURPLE.get(), JJKAbilities.TELEPORT.get(), JJKAbilities.FLY.get()),
    DISMANTLE_AND_CLEAVE(JJKAbilities.MALEVOLENT_SHRINE.get(), JJKAbilities.DISMANTLE.get(), JJKAbilities.DISMANTLE_BARRAGE.get(), JJKAbilities.CLEAVE.get(), JJKAbilities.SPIDERWEB.get(), JJKAbilities.FIRE_ARROW.get()),
    ...
    COPY(null, JJKAbilities.RIKA.get(), JJKAbilities.COPY.get(), JJKAbilities.COMMAND_PURE_LOVE.get()),
    ...
    DISASTER_PLANTS(JJKAbilities.SHINING_SEA_OF_FLOWERS.get(), JJKAbilities.FOREST_PLATFORM.get(), JJKAbilities.FOREST_SPIKES.get(), JJKAbilities.WOOD_SHIELD.get(), JJKAbilities.CURSED_BUD.get(), JJKAbilities.FOREST_WAVE.get()),
    ...
    PROJECTION_SORCERY(null, JJKAbilities.PROJECTION_SORCERY.get(), JJKAbilities.TWENTY_FOUR_FRAME_RULE.get());
