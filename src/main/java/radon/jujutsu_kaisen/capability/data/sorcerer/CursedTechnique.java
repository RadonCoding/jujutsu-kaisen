...
public enum CursedTechnique {
    ...
    LIMITLESS(JJKAbilities.UNLIMITED_VOID.get(), JJKAbilities.INFINITY.get(), JJKAbilities.RED.get(), JJKAbilities.BLUE.get(),
            JJKAbilities.MAXIMUM_BLUE_MOTION.get(), JJKAbilities.MAXIMUM_BLUE_STILL.get(), JJKAbilities.BLUE_FISTS.get(), JJKAbilities.HOLLOW_PURPLE.get(), JJKAbilities.TELEPORT.get()),
