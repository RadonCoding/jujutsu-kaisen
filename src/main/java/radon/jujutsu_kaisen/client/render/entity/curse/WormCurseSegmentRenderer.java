...
public class WormCurseSegmentRenderer extends GeoEntityRenderer<WormCurseSegmentEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, WormCurseSegmentEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
