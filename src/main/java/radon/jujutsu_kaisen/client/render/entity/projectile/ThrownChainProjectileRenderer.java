...
public class ThrownChainProjectileRenderer extends EntityRenderer<ThrownChainProjectile> {
    ...
    public void render(@NotNull ThrownChainProjectile pEntity, float pEntityYaw, float pPartialTick, @NotNull PoseStack pPoseStack, @NotNull MultiBufferSource pBuffer, int pPackedLight) {
        ...
        vertex(consumer, matrix4f, pose, f4, f0, f5, j, k, l, 0.4999F, f13, pPackedLight);
        vertex(consumer, matrix4f, pose, f4, 0.0F, f5, j, k, l, 0.4999F, f12, pPackedLight);
        vertex(consumer, matrix4f, pose, f6, 0.0F, f7, j, k, l, 0.0F, f12, pPackedLight);
        vertex(consumer, matrix4f, pose, f6, f0, f7, j, k, l, 0.0F, f13, pPackedLight);

        vertex(consumer, matrix4f, pose, f8, f0, f9, j, k, l, 0.4999F, f15, pPackedLight);
        vertex(consumer, matrix4f, pose, f8, 0.0F, f9, j, k, l, 0.4999F, f14, pPackedLight);
        vertex(consumer, matrix4f, pose, f10, 0.0F, f11, j, k, l, 0.0F, f14, pPackedLight);
        vertex(consumer, matrix4f, pose, f10, f0, f11, j, k, l, 0.0F, f15, pPackedLight);
        pPoseStack.popPose();
    }

    private static void vertex(VertexConsumer consumer, Matrix4f matrix4f, PoseStack.Pose pose, float x, float y, float z, int r, int g, int b, float u, float v, int packedLight) {
