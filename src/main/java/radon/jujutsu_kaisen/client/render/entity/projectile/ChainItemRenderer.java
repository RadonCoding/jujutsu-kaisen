...
public class ChainItemRenderer extends EntityRenderer<ChainItemProjectile> {
    ...
    public ChainItemRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull ChainItemProjectile pEntity) {
        return null;
    }
}
