...
public class SukunaRyomenRenderer extends HumanoidMobRenderer<SukunaRyomenEntity, SukunaRyomenModel> {
    ...
    public SukunaRyomenRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new SukunaRyomenModel(renderManager.bakeLayer(TojiFushiguroModel.LAYER)), 0.5F);
