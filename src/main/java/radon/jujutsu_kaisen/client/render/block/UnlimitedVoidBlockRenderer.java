...
public class UnlimitedVoidBlockRenderer implements BlockEntityRenderer<UnlimitedVoidBlockEntity> {
    public UnlimitedVoidBlockRenderer(BlockEntityRendererProvider.Context ignored) {
    }
    ...
    protected RenderType renderType() {
        return JJKRenderTypes.skybox(SkyHandler.getUnlimitedVoidTarget());
    }
}