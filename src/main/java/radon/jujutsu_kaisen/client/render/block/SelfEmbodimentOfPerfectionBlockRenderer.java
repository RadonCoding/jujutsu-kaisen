...
public class SelfEmbodimentOfPerfectionBlockRenderer implements BlockEntityRenderer<SelfEmbodimentOfPerfectionBlockEntity> {
    public SelfEmbodimentOfPerfectionBlockRenderer(BlockEntityRendererProvider.Context ignored) {
    }

    public void render(@NotNull SelfEmbodimentOfPerfectionBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
    ...
    protected RenderType renderType() {
        return JJKRenderTypes.skybox(SkyHandler.getSelfEmbodimentOfPerfectionTarget());
    }
}