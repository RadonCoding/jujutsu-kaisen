...
import radon.jujutsu_kaisen.block.entity.HorizonOTheCaptivatingSkandhaBlockEntity;
...
public class HorizonOfTheCaptivatingSkandhaBlockRenderer implements BlockEntityRenderer<HorizonOTheCaptivatingSkandhaBlockEntity> {
    public HorizonOfTheCaptivatingSkandhaBlockRenderer(BlockEntityRendererProvider.Context ignored) {
    }

    public void render(@NotNull HorizonOTheCaptivatingSkandhaBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
    ...
    protected RenderType renderType() {
        return JJKRenderTypes.skybox(SkyHandler.getHorizonOfTheCaptivatingSkandhaTarget());
    }
}