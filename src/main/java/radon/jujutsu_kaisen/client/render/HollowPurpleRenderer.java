...
import radon.jujutsu_kaisen.entity.HollowPurpleProjectile;
import radon.jujutsu_kaisen.util.HelperMethods;
import software.bernie.geckolib.renderer.GeoEntityRenderer;

public class HollowPurpleRenderer extends GeoEntityRenderer<HollowPurpleProjectile> {
    private static final RenderType RED = JujutsuRenderTypes.glow(new ResourceLocation(JujutsuKaisen.MOD_ID, "textures/entity/red.png"));
    private static final RenderType BLUE = JujutsuRenderTypes.glow(new ResourceLocation(JujutsuKaisen.MOD_ID, "textures/entity/blue.png"));
    private static final RenderType PURPLE = JujutsuRenderTypes.glow(new ResourceLocation(JujutsuKaisen.MOD_ID, "textures/entity/hollow_purple.png"));
