...
public class BlueFistsVisual {
    ...
    private static void spawn(Level level, Vec3 pos) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            level.addParticle(new TravelParticle.TravelParticleOptions(pos.toVector3f(), ParticleColors.DARK_BLUE_COLOR, RADIUS * 0.25F, 1.0F, true, 1),
        ...
        for (int i = 0; i < count; i++) {
            ...
            level.addParticle(new TravelParticle.TravelParticleOptions(pos.toVector3f(), ParticleColors.LIGHT_BLUE_COLOR, RADIUS * 0.25F, 1.0F, true, 1),
                    x, y, z, 0.0D, 0.0D, 0.0D);
        }
    }
