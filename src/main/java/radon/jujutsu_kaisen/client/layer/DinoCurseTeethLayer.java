...
public class DinoCurseTeethLayer extends GeoRenderLayer<DinoCurseEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(JujutsuKaisen.MOD_ID, "textures/entity/dino_curse_teeth.png");

    public DinoCurseTeethLayer(GeoRenderer<DinoCurseEntity> entityRendererIn) {
