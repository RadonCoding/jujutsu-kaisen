...
public class JJKItems {
    ...
    public static RegistryObject<Item> DRAGON_BONE_SWORD = ITEMS.register("dragon_bone_sword",
            () -> new DragonBoneSwordItem(JJKTiers.CURSED_TOOL, 6, -2.8F, new Item.Properties()));
