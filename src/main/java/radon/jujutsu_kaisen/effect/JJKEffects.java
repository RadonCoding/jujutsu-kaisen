...
public class JJKEffects {
    ...
    public static RegistryObject<MobEffect> STUN = EFFECTS.register("stun", () -> new StunEffect(MobEffectCategory.NEUTRAL, 0xFFFFFF));
    public static RegistryObject<MobEffect> UNLIMITED_VOID = EFFECTS.register("unlimited_void", () -> new StunEffect(MobEffectCategory.HARMFUL, 0x000000));
