...
public class WaterTorrentEntity extends JujutsuProjectile {
    ...
    private static final EntityDataAccessor<Float> DATA_YAW = SynchedEntityData.defineId(WaterTorrentEntity.class, EntityDataSerializers.FLOAT);

    private static final EntityDataAccessor<Float> DATA_PITCH = SynchedEntityData.defineId(WaterTorrentEntity.class, EntityDataSerializers.FLOAT);
        ...
        if (this.getOwner() instanceof LivingEntity owner) {
            ...
            owner.getCapability(SorcererDataHandler.INSTANCE).ifPresent(cap -> {
                for (Entity entity : entities) {
                    ...
                    entity.hurt(JJKDamageSources.indirectJujutsuAttack(this, owner, JJKAbilities.WATER_TORRENT.get()), DAMAGE * cap.getAbilityPower(owner));
                }
            });
