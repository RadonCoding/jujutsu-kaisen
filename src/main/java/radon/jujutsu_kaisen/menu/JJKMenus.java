...
public class JJKMenus {
    ...
    public static DeferredHolder<MenuType<?>, MenuType<VeilRodMenu>> VEIL_ROD = MENUS.register("veil_rod", () ->
            new MenuType<>((pContainerId, pPlayerInventory) -> new VeilRodMenu(pContainerId), FeatureFlags.DEFAULT_FLAGS));    public static DeferredHolder<MenuType<?>, MenuType<AltarMenu>> ALTAR = MENUS.register("altar", () ->
