...
public class PacketHandler {
    ...
    public static void register() {
        INSTANCE = NetworkRegistry.ChannelBuilder
                ...
                .simpleChannel();
        INSTANCE.messageBuilder(SyncSorcererDataS2CPacket.class, id(), PlayNetworkDirection.PLAY_TO_CLIENT)
                ...
                .add();
        INSTANCE.messageBuilder(SyncTenShadowsDataS2CPacket.class, id(), PlayNetworkDirection.PLAY_TO_CLIENT)
                ...
                .add();
        INSTANCE.messageBuilder(SyncProjectionSorceryDataS2CPacket.class, id(), PlayNetworkDirection.PLAY_TO_CLIENT)
                ...
                .add();
        INSTANCE.messageBuilder(SyncCurseManipulationDataS2CPacket.class, id(), PlayNetworkDirection.PLAY_TO_CLIENT)
                ...
                .add();
        INSTANCE.messageBuilder(TriggerAbilityC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        INSTANCE.messageBuilder(OpenInventoryCurseC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        INSTANCE.messageBuilder(CameraShakeS2CPacket.class, id(), PlayNetworkDirection.PLAY_TO_CLIENT)
                .decoder(CameraShakeS2CPacket::new)
                .encoder(CameraShakeS2CPacket::encode)
                .consumerMainThread(CameraShakeS2CPacket::handle)
                .add();
        INSTANCE.messageBuilder(CommandableTargetC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        INSTANCE.messageBuilder(SetOverlayMessageS2CPacket.class, id(), PlayNetworkDirection.PLAY_TO_CLIENT)
                ...
                .add();
        INSTANCE.messageBuilder(JumpInputListenerC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        INSTANCE.messageBuilder(RightClickInputListenerC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        INSTANCE.messageBuilder(SetSizeC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
        ...
        INSTANCE.messageBuilder(SetCostS2CPacket.class, id(), PlayNetworkDirection.PLAY_TO_CLIENT)
                ...
                .add();
        INSTANCE.messageBuilder(RequestCostC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                .decoder(RequestCostC2SPacket::new)
                .encoder(RequestCostC2SPacket::encode)
                .consumerMainThread(RequestCostC2SPacket::handle)
                .add();
        INSTANCE.messageBuilder(SetTojiBountyC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                .decoder(SetTojiBountyC2SPacket::new)
                .encoder(SetTojiBountyC2SPacket::encode)
                .consumerMainThread(SetTojiBountyC2SPacket::handle)
                .add();
        INSTANCE.messageBuilder(KuchisakeOnnaAnswerC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        INSTANCE.messageBuilder(ShadowInventoryTakeC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        INSTANCE.messageBuilder(CurseSummonC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                .decoder(CurseSummonC2SPacket::new)
                .encoder(CurseSummonC2SPacket::encode)
                .consumerMainThread(CurseSummonC2SPacket::handle)
                .add();
        INSTANCE.messageBuilder(SetCopiedC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                .decoder(SetCopiedC2SPacket::new)
                .encoder(SetCopiedC2SPacket::encode)
                .consumerMainThread(SetCopiedC2SPacket::handle)
                .add();
        INSTANCE.messageBuilder(SetAbsorbedC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                .decoder(SetAbsorbedC2SPacket::new)
                .encoder(SetAbsorbedC2SPacket::encode)
                .consumerMainThread(SetAbsorbedC2SPacket::handle)
                .add();
        INSTANCE.messageBuilder(RequestVisualDataC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        INSTANCE.messageBuilder(ReceiveVisualDataS2CPacket.class, id(), PlayNetworkDirection.PLAY_TO_CLIENT)
                ...
                .add();
        INSTANCE.messageBuilder(SetDomainSizeC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                .decoder(SetDomainSizeC2SPacket::new)
                .encoder(SetDomainSizeC2SPacket::encode)
                .consumerMainThread(SetDomainSizeC2SPacket::handle)
                .add();
        INSTANCE.messageBuilder(ScreenFlashS2CPacket.class, id(), PlayNetworkDirection.PLAY_TO_CLIENT)
                .decoder(ScreenFlashS2CPacket::new)
                .encoder(ScreenFlashS2CPacket::encode)
                .consumerMainThread(ScreenFlashS2CPacket::handle)
                .add();
        INSTANCE.messageBuilder(QuestionCreatePactC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        INSTANCE.messageBuilder(AddBindingVowC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                .decoder(AddBindingVowC2SPacket::new)
                .encoder(AddBindingVowC2SPacket::encode)
                .consumerMainThread(AddBindingVowC2SPacket::handle)
                .add();
        INSTANCE.messageBuilder(RemoveBindingVowC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
        ...
        INSTANCE.messageBuilder(SyncVisualDataS2CPacket.class, id(), PlayNetworkDirection.PLAY_TO_CLIENT)
                ...
                .add();
        INSTANCE.messageBuilder(SyncMouthS2CPacket.class, id(), PlayNetworkDirection.PLAY_TO_CLIENT)
                .decoder(SyncMouthS2CPacket::new)
                .encoder(SyncMouthS2CPacket::encode)
                .consumerMainThread(SyncMouthS2CPacket::handle)
                .add();
        INSTANCE.messageBuilder(TransformationRightClickC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        INSTANCE.messageBuilder(QuestionRemovePactC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        INSTANCE.messageBuilder(NyoiStaffSummonLightningC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        INSTANCE.messageBuilder(SetCursedEnergyColorC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        INSTANCE.messageBuilder(UntriggerAbilityC2SPacket.class, id(),  PlayNetworkDirection.PLAY_TO_SERVER)
                ...
                .add();
        INSTANCE.messageBuilder(AddChantS2CPacket.class, id(), PlayNetworkDirection.PLAY_TO_CLIENT)
                .decoder(AddChantS2CPacket::new)
                .encoder(AddChantS2CPacket::encode)
                .consumerMainThread(AddChantS2CPacket::handle)
                .add();
        INSTANCE.messageBuilder(RemoveChantS2CPacket.class, id(), PlayNetworkDirection.PLAY_TO_CLIENT)
                .decoder(RemoveChantS2CPacket::new)
                .encoder(RemoveChantS2CPacket::encode)
                .consumerMainThread(RemoveChantS2CPacket::handle)
                .add();
        INSTANCE.messageBuilder(ClearChantsC2SPacket.class, id(), PlayNetworkDirection.PLAY_TO_CLIENT)
