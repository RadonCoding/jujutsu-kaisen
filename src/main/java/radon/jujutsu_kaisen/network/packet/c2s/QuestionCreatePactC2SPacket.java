...
public class QuestionCreatePactC2SPacket {
    ...
    public void handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        ctx.enqueueWork(() -> {
            ...
            cap.createPactRequest(this.identifier, this.pact);
            ...
            if (player != null) {
                Component accept = Component.translatable(String.format("chat.%s.pact_question_accept", JujutsuKaisen.MOD_ID))
                        .withStyle(Style.EMPTY.
                                ...
                                .withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, String.format("/pactaccept %s %s", sender.getName().getString(), this.pact.name())))
                ...
                Component decline = Component.translatable(String.format("chat.%s.pact_question_decline", JujutsuKaisen.MOD_ID))
                        .withStyle(Style.EMPTY
                                ...
                                .withClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, String.format("/pactdecline %s %s", sender.getName().getString(), this.pact.name())))
                ...
                Component message = Component.translatable(String.format("chat.%s.pact_question", JujutsuKaisen.MOD_ID), accept, decline,
