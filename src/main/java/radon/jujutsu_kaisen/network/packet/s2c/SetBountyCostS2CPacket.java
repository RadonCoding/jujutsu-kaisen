...
public class SetBountyCostS2CPacket implements CustomPacketPayload {
    public static final ResourceLocation IDENTIFIER = new ResourceLocation(JujutsuKaisen.MOD_ID, "set_cost_clientbound");

    private final int cost;

    public SetBountyCostS2CPacket(int cost) {
        this.cost = cost;
    }

    public SetBountyCostS2CPacket(FriendlyByteBuf buf) {
        this(buf.readInt());
    }
