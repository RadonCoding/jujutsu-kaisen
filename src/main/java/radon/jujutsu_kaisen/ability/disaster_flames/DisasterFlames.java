        ...
        owner.getCapability(SorcererDataHandler.INSTANCE).ifPresent(cap -> {
            ...
            if (target == null) {
                for (Entity entity : this.getTargets(owner)) {
                    if (entity.hurt(JJKDamageSources.indirectJujutsuAttack(owner, owner, this), DAMAGE * cap.getGrade().getPower())) {
                ...
                if (target.hurt(JJKDamageSources.indirectJujutsuAttack(owner, owner, this), (DAMAGE * 2) * cap.getGrade().getPower())) {
