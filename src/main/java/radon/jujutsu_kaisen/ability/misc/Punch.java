...
public class Punch extends Ability {
    ...
    public void run(LivingEntity owner) {
        ...
        for (LivingEntity entity : EntityUtil.getTargetableEntities(LivingEntity.class, owner.level(), owner, bounds)) {
            ...
            entity.level().playSound(null, center.x, center.y, center.z, SoundEvents.GENERIC_EXPLODE.value(), SoundSource.MASTER, 1.0F, 1.0F);
        ...
        if (!hit) {
            BlockPos.betweenClosedStream(bounds).forEach(pos -> {
                ...
                BlockHitResult blockHit = owner.level().clip(new ClipContext(owner.getEyePosition(), pos.getCenter(),
