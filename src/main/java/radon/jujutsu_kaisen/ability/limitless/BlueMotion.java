...
public class BlueMotion extends Ability {
    ...
    public void run(LivingEntity owner) {
        ...
        BlueProjectile blue = new BlueProjectile(owner, getPower(owner), true);
    ...
    public Status checkTriggerable(LivingEntity owner) {
        ...
        return cap.isCooldownDone(JJKAbilities.BLUE_STILL.get()) ? super.checkTriggerable(owner) : Status.FAILURE;
    }
